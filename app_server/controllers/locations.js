...
if ('production' === process.env.NODE_ENV) {
  apiOptions.server = 'http://mean-loc8r.herokuapp.com';
};

var _formatDistance = function(distance) {
  // TODO: add some error trapping to ensure that
  //    * a distance parameter has been passed, and
  //    * that it is a number.
...
var renderDetailPage = function (req, res, locDetail) {
  res.render('location-info', {
    ...
    sidebar: {
      ...
      cta: 'If you\'ve been here and you like it - or if you don\'t - please \
...
var renderReviewForm = function (req, res, locDetail) {
  res.render('location-review-form', {
    // TODO: the name of the coffee shop is not to be hardcoded here.
